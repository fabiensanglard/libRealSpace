...
void SCCockpit::Update() {
    ...
    this->weapoint_coords.x = this->current_mission->mission->mission_data.areas[*this->nav_point_id]->position.x;
    this->weapoint_coords.y = this->current_mission->mission->mission_data.areas[*this->nav_point_id]->position.z;
