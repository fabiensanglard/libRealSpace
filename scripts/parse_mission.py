...
opcodes = {
    ...
    72: '[72 ] IF TRUE GOTO',
    73: '[73 ] IF FALSE GOTO',
    80: '[80 ] SAVE WORK REGISTER TO FLAG',
    16: '[16 ] LOAD VALUE TO WORK REGISTER',
    8: '[8  ] CREATE LABEL',
    1: '[1  ] EXIT',
    2: '[2  ] EXEC SUB PROG',
    17: '[17 ] MOVE FLAG TO WORK REGISTER',
    20: '[20 ] SAVE VALUE TO FLAG',
    35: '[35 ] ADD WORK REGISTER TO FLAG',
    64: '[64 ] CMP GREATER EQUAL THAN',
    74: '[74 ] IF TRUE GOTO',
    79: '[79 ] GOTO FROM LABEL IN WORK REGISTER',
    85: '[85 ] ADD 1 TO FLAG',
